...
from base_predict_functions import orignal_predict, smooth_predict_for_multiclass
...
model_file = ''.join(['../../data/models/',dict_network[FLAG_USING_NETWORK], '_multiclass''.h5'])
