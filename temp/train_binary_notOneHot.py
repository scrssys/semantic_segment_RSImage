...
from semantic_segmentation_networks import binary_unet_jaccard_notOnehot, binary_fcnnet_jaccard, binary_segnet_jaccard
...
model_save_path = ''.join(['../../data/models/sat_urban_rgb/',dict_network[FLAG_USING_NETWORK], '_', dict_target[FLAG_TARGET_CLASS],'_binary_jaccard_notonehot.h5'])
...
if __name__ == '__main__':
    ...
    if FLAG_USING_NETWORK==0:
        model = binary_unet_jaccard_notOnehot(n_label)
