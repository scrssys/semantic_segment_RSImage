...
class Ui_Dialog_label_check(object):
    def setupUi(self, Dialog_label_check):
        ...
        Dialog_label_check.resize(391, 167)
        ...
        self.layoutWidget = QtWidgets.QWidget(Dialog_label_check)
        self.layoutWidget.setGeometry(QtCore.QRect(10, 20, 370, 107))
        ...
        self.pushButton_inputpath = QtWidgets.QPushButton(self.layoutWidget)
    ...
    def retranslateUi(self, Dialog_label_check):
        ...
        Dialog_label_check.setWindowTitle(_translate("Dialog_label_check", "Check label files"))
        self.label.setText(_translate("Dialog_label_check", "label dir:"))
