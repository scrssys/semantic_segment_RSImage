...
# Form implementation generated from reading ui file 'TrainBinaryCrossentropy.ui'
#
...
class Ui_Dialog_train_binary_crossentropy(object):
    def setupUi(self, Dialog_train_binary_crossentropy):
        Dialog_train_binary_crossentropy.setObjectName("Dialog_train_binary_crossentropy")
        Dialog_train_binary_crossentropy.resize(430, 373)
        self.buttonBox = QtWidgets.QDialogButtonBox(Dialog_train_binary_crossentropy)
        self.buttonBox.setGeometry(QtCore.QRect(160, 330, 261, 32))
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.Cancel|QtWidgets.QDialogButtonBox.Ok)
        self.buttonBox.setObjectName("buttonBox")
        self.widget = QtWidgets.QWidget(Dialog_train_binary_crossentropy)
        self.widget.setGeometry(QtCore.QRect(0, 10, 431, 311))
        ...
        self.retranslateUi(Dialog_train_binary_crossentropy)
        self.pushButton_trainpath.clicked.connect(Dialog_train_binary_crossentropy.slot_traindatapath)
        self.pushButton_basemodel.clicked.connect(Dialog_train_binary_crossentropy.slot_basemodel)
        self.pushButton_savemodel.clicked.connect(Dialog_train_binary_crossentropy.slot_savemodelpath)
        self.buttonBox.accepted.connect(Dialog_train_binary_crossentropy.slot_ok)
        QtCore.QMetaObject.connectSlotsByName(Dialog_train_binary_crossentropy)

    def retranslateUi(self, Dialog_train_binary_crossentropy):
        _translate = QtCore.QCoreApplication.translate
        Dialog_train_binary_crossentropy.setWindowTitle(_translate("Dialog_train_binary_crossentropy", "Train model for binary cross-entropy"))
        self.label.setText(_translate("Dialog_train_binary_crossentropy", "traindata path:"))
        self.pushButton_trainpath.setText(_translate("Dialog_train_binary_crossentropy", "Open"))
        self.label_8.setText(_translate("Dialog_train_binary_crossentropy", "bands:"))
        self.label_9.setText(_translate("Dialog_train_binary_crossentropy", "dtype:"))
        self.comboBox_dtype.setItemText(0, _translate("Dialog_train_binary_crossentropy", "uint8"))
        self.comboBox_dtype.setItemText(1, _translate("Dialog_train_binary_crossentropy", "uint10"))
        self.comboBox_dtype.setItemText(2, _translate("Dialog_train_binary_crossentropy", "uint16"))
        self.comboBox_dtype.setItemText(3, _translate("Dialog_train_binary_crossentropy", "float"))
        self.label_3.setText(_translate("Dialog_train_binary_crossentropy", "windsize :"))
        self.label_4.setText(_translate("Dialog_train_binary_crossentropy", "base model:"))
        self.pushButton_basemodel.setText(_translate("Dialog_train_binary_crossentropy", "Open"))
        self.label_10.setText(_translate("Dialog_train_binary_crossentropy", "GPU ID:"))
        self.comboBox_gupid.setItemText(0, _translate("Dialog_train_binary_crossentropy", "0"))
        self.comboBox_gupid.setItemText(1, _translate("Dialog_train_binary_crossentropy", "1"))
        self.comboBox_gupid.setItemText(2, _translate("Dialog_train_binary_crossentropy", "2"))
        self.comboBox_gupid.setItemText(3, _translate("Dialog_train_binary_crossentropy", "3"))
        self.comboBox_gupid.setItemText(4, _translate("Dialog_train_binary_crossentropy", "4"))
        self.comboBox_gupid.setItemText(5, _translate("Dialog_train_binary_crossentropy", "5"))
        self.label_5.setText(_translate("Dialog_train_binary_crossentropy", "batch size:"))
        self.label_7.setText(_translate("Dialog_train_binary_crossentropy", "ecpoch:"))
        self.groupBox_network.setTitle(_translate("Dialog_train_binary_crossentropy", "Network"))
        self.radioButton_unet.setText(_translate("Dialog_train_binary_crossentropy", "Unet"))
        self.radioButton_fcnnet.setText(_translate("Dialog_train_binary_crossentropy", "Fcnnet"))
        self.radioButton_segnet.setText(_translate("Dialog_train_binary_crossentropy", "Segnet"))
        self.groupBox_5.setTitle(_translate("Dialog_train_binary_crossentropy", "Class"))
        self.label_2.setText(_translate("Dialog_train_binary_crossentropy", "Target:"))
        self.comboBox_target_class.setItemText(0, _translate("Dialog_train_binary_crossentropy", "roads"))
        self.comboBox_target_class.setItemText(1, _translate("Dialog_train_binary_crossentropy", "buildings"))
        self.comboBox_target_class.setItemText(2, _translate("Dialog_train_binary_crossentropy", "vegetation"))
        self.comboBox_target_class.setItemText(3, _translate("Dialog_train_binary_crossentropy", "water"))
        self.comboBox_target_class.setItemText(4, _translate("Dialog_train_binary_crossentropy", "else"))
        self.label_6.setText(_translate("Dialog_train_binary_crossentropy", "model save path:"))
        self.pushButton_savemodel.setText(_translate("Dialog_train_binary_crossentropy", "Open"))
