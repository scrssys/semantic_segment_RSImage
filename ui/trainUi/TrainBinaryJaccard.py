...
class Ui_Dialog_train_binary_jaccard(object):
    def setupUi(self, Dialog_train_binary_jaccard):
        ...
        self.layoutWidget = QtWidgets.QWidget(Dialog_train_binary_jaccard)
        self.layoutWidget.setGeometry(QtCore.QRect(0, 10, 431, 321))
    ...
    def retranslateUi(self, Dialog_train_binary_jaccard):
        ...
        self.label_7.setText(_translate("Dialog_train_binary_jaccard", "epoch:"))
