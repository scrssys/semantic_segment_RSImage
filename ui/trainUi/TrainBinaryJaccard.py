...
# Form implementation generated from reading ui file 'TrainBinaryJaccard.ui'
#
...
class Ui_Dialog_train_binary_jaccard(object):
    def setupUi(self, Dialog_train_binary_jaccard):
        Dialog_train_binary_jaccard.setObjectName("Dialog_train_binary_jaccard")
        Dialog_train_binary_jaccard.resize(430, 372)
        self.buttonBox = QtWidgets.QDialogButtonBox(Dialog_train_binary_jaccard)
        self.buttonBox.setGeometry(QtCore.QRect(80, 340, 341, 32))
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.Cancel|QtWidgets.QDialogButtonBox.Ok)
        self.buttonBox.setObjectName("buttonBox")
        self.widget = QtWidgets.QWidget(Dialog_train_binary_jaccard)
        ...
        self.retranslateUi(Dialog_train_binary_jaccard)
        self.pushButton_trainpath.clicked.connect(Dialog_train_binary_jaccard.slot_traindatapath)
        self.pushButton_basemodel.clicked.connect(Dialog_train_binary_jaccard.slot_basemodel)
        self.pushButton_savemodel.clicked.connect(Dialog_train_binary_jaccard.slot_savemodelpath)
        self.buttonBox.accepted.connect(Dialog_train_binary_jaccard.slot_ok)
        QtCore.QMetaObject.connectSlotsByName(Dialog_train_binary_jaccard)

    def retranslateUi(self, Dialog_train_binary_jaccard):
        _translate = QtCore.QCoreApplication.translate
        Dialog_train_binary_jaccard.setWindowTitle(_translate("Dialog_train_binary_jaccard", "Train model for binary jaccard"))
        self.label.setText(_translate("Dialog_train_binary_jaccard", "traindata path:"))
        self.pushButton_trainpath.setText(_translate("Dialog_train_binary_jaccard", "Open"))
        self.label_8.setText(_translate("Dialog_train_binary_jaccard", "bands:"))
        self.label_9.setText(_translate("Dialog_train_binary_jaccard", "dtype:"))
        self.comboBox_dtype.setItemText(0, _translate("Dialog_train_binary_jaccard", "uint8"))
        self.comboBox_dtype.setItemText(1, _translate("Dialog_train_binary_jaccard", "uint10"))
        self.comboBox_dtype.setItemText(2, _translate("Dialog_train_binary_jaccard", "uint16"))
        self.comboBox_dtype.setItemText(3, _translate("Dialog_train_binary_jaccard", "float"))
        self.label_3.setText(_translate("Dialog_train_binary_jaccard", "windsize :"))
        self.label_4.setText(_translate("Dialog_train_binary_jaccard", "base model:"))
        self.pushButton_basemodel.setText(_translate("Dialog_train_binary_jaccard", "Open"))
        self.label_10.setText(_translate("Dialog_train_binary_jaccard", "GPU ID:"))
        self.comboBox_gupid.setItemText(0, _translate("Dialog_train_binary_jaccard", "0"))
        self.comboBox_gupid.setItemText(1, _translate("Dialog_train_binary_jaccard", "1"))
        self.comboBox_gupid.setItemText(2, _translate("Dialog_train_binary_jaccard", "2"))
        self.comboBox_gupid.setItemText(3, _translate("Dialog_train_binary_jaccard", "3"))
        self.comboBox_gupid.setItemText(4, _translate("Dialog_train_binary_jaccard", "4"))
        self.comboBox_gupid.setItemText(5, _translate("Dialog_train_binary_jaccard", "5"))
        self.label_5.setText(_translate("Dialog_train_binary_jaccard", "batch size:"))
        self.label_7.setText(_translate("Dialog_train_binary_jaccard", "ecpoch:"))
        self.groupBox_network.setTitle(_translate("Dialog_train_binary_jaccard", "Network"))
        self.radioButton_unet.setText(_translate("Dialog_train_binary_jaccard", "Unet"))
        self.radioButton_fcnnet.setText(_translate("Dialog_train_binary_jaccard", "Fcnnet"))
        self.radioButton_segnet.setText(_translate("Dialog_train_binary_jaccard", "Segnet"))
        self.groupBox_5.setTitle(_translate("Dialog_train_binary_jaccard", "Class"))
        self.label_2.setText(_translate("Dialog_train_binary_jaccard", "Target:"))
        self.comboBox_target_class.setItemText(0, _translate("Dialog_train_binary_jaccard", "roads"))
        self.comboBox_target_class.setItemText(1, _translate("Dialog_train_binary_jaccard", "buildings"))
        self.comboBox_target_class.setItemText(2, _translate("Dialog_train_binary_jaccard", "vegetation"))
        self.comboBox_target_class.setItemText(3, _translate("Dialog_train_binary_jaccard", "water"))
        self.comboBox_target_class.setItemText(4, _translate("Dialog_train_binary_jaccard", "else"))
        self.label_6.setText(_translate("Dialog_train_binary_jaccard", "model save path:"))
        self.pushButton_savemodel.setText(_translate("Dialog_train_binary_jaccard", "Open"))
