...
class Ui_Dialog_train_binary_onehot(object):
    def setupUi(self, Dialog_train_binary_onehot):
        ...
        self.layoutWidget = QtWidgets.QWidget(Dialog_train_binary_onehot)
        self.layoutWidget.setGeometry(QtCore.QRect(1, 1, 421, 331))
    ...
    def retranslateUi(self, Dialog_train_binary_onehot):
        ...
        self.label_7.setText(_translate("Dialog_train_binary_onehot", "epoch:"))
