...
def generateData_onehot(batch_size,im_bands, im_type, train_data_path, img_w, img_h, n_label, data=[]):
    # print 'generateData...'
    while True:
        train_data = []
        train_label = []
...
# data for validation
def generateValidData_onehot(batch_size,im_bands,im_type,  train_data_path, img_w, img_h, n_label,data=[]):
    # print 'generateValidData...'
    while True:
        valid_data = []
        valid_label = []
...
def train_binary_jaccCross(input_dict={}):
    ...
    if os.path.isdir(input_dict['saveModel_path']):
        model_path = ''.join([input_dict['saveModel_path'], '/', input_dict['network'], '_',
                                   input_dict['target_class'], '_binary_jaccardandCrossentropy_', str(input_dict['windsize']), '_',
                                   date_time, '.h5'])
...
def train_binary_jaccard(input_dict={}):
    # self.input_dict = input_dict
    ...
    if os.path.isdir(input_dict['saveModel_path']):
        model_path = ''.join([input_dict['saveModel_path'], '/', input_dict['network'], '_',
                                   input_dict['target_class'], '_binary_jaccardonly_', str(input_dict['windsize']), '_',
                                   date_time, '.h5'])
        saveModel_path = input_dict['saveModel_path']
    else:
        sys.exit(-3)
...
def train_binary_onehot(input_dict={}):
    # self.input_dict = input_dict
    ...
    if os.path.isdir(input_dict['saveModel_path']):
        model_path = ''.join([input_dict['saveModel_path'], '/', input_dict['network'], '_',
                                   input_dict['target_class'], '_binary_corssentropy_onehot_', str(input_dict['windsize']), '_',
                                   date_time, '.h5'])
        saveModel_path = input_dict['saveModel_path']
    else:
        sys.exit(-3)
    ...
    H = model.fit_generator(generator=generateData_onehot(BS,im_bands,im_type, train_data_path, img_w, img_h, n_label, train_set),
                            steps_per_epoch=train_numb // BS,
                            epochs=EPOCHS,
                            verbose=1,
                            validation_data=generateValidData_onehot(BS,im_bands,im_type, train_data_path, img_w, img_h, n_label, val_set),
                            validation_steps=valid_numb // BS,
                            callbacks=callable)
...
def train_binary_crossentropy(input_dict={}):
    # self.input_dict = input_dict
    ...
    if os.path.isdir(input_dict['saveModel_path']):
        model_path = ''.join([input_dict['saveModel_path'], '/', input_dict['network'], '_',
                                   input_dict['target_class'], '_binary_crossentropy_', str(input_dict['windsize']), '_',
                                   date_time, '.h5'])
        saveModel_path = input_dict['saveModel_path']
    else:
        sys.exit(-3)
...
def train_multiclass(input_dict={}):
    # self.input_dict = input_dict
    ...
    if os.path.isdir(input_dict['saveModel_path']):
        model_path = ''.join([input_dict['saveModel_path'], '/', input_dict['network'], '_',
                              '_multiclass_crossentropy_', str(input_dict['windsize']), '_',
                                   date_time, '.h5'])
        saveModel_path = input_dict['saveModel_path']
    else:
        sys.exit(-3)
    ...
    plt.ylabel("Loss/Accuracy")
    plt.legend(loc="lower left")
    fig_train_acc = ''.join([saveModel_path, network, '_multiclass.png'])
    plt.savefig(fig_train_acc)

    return 0


def test_train(input_dict={}):
    if os.path.isdir(input_dict['trainData_path']):
        train_data_path = input_dict['trainData_path']
    else:
        sys.exit(-2)
    ...
    H = model.fit_generator(generator=generateData(BS,im_bands,im_type, train_data_path, img_w, img_h, n_label, train_set), steps_per_epoch=train_numb // BS, epochs=EPOCHS,
                            verbose=1,
                            validation_data=generateValidData(BS,im_bands,im_type, train_data_path, img_w, img_h, n_label,  val_set), validation_steps=valid_numb // BS,
